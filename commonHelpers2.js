import"./assets/header-0053ffc9.js";import{a as m}from"./assets/vendor-169f9f98.js";const r=document.querySelector(".slist-card-section"),u=document.querySelector(".slist-demo-thumb"),n="local-storage-books";let e=[];function p(s){try{const o=localStorage.getItem(s),t=JSON.parse(o);return console.log(t),e=t.map(l=>l.dataId),console.log(e),e}catch{console.log("error"),c()}}const b=p(n);console.log(e);k(b);async function k(s){let o=[];if(s===null||s.length===0||!n)c();else{for(const l of s){const a=await y(l);o.push(a)}const t=h(o);r.innerHTML=t,r.addEventListener("click",v)}}function f({_id:s,book_image:o,title:t,list_name:l,description:a,author:i,amazonURL:g,appleURL:d}){return`<div class="slist-card-list">
              ...
              <div class="slist-info-container">
                ...
                <div class="slist-nav">
                  <ul class="slist-nav-list">
                    ...
                    <li class="slist-nav-item">
                      <a href="${d}" class="slist-nav-link"><img class="img-app logo" src="./img/appbook.png" alt="app"></a>
