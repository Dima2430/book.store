import"./assets/header-1d09e868.js";import{a as p}from"./assets/vendor-169f9f98.js";const n=document.querySelector(".slist-card-section"),u=document.querySelector(".slist-demo-thumb"),l="local-storage-books";let r=[];function b(s){try{const t=localStorage.getItem(s),o=JSON.parse(t);return console.log(o),r=o.map(a=>a.dataId),console.log(r),r}catch{console.log("error"),d()}}const k=b(l);g(k);async function g(s){let t=[];if(s===null||s.length===0||!l)d();else{for(const a of s){const e=await S(a);t.push(e)}const o=v(t);n.innerHTML=o,n.addEventListener("click",f)}}function h({_id:s,book_image:t,title:o,list_name:a,description:e,author:c,amazonURL:i,appleURL:m}){return`<div class="slist-card-list">
